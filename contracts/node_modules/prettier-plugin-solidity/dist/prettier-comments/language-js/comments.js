...
const { addLeadingComment, addTrailingComment, addDanglingComment, hasNewline, hasNewlineInRange, getNextNonSpaceNonCommentCharacter, getNextNonSpaceNonCommentCharacterIndex } = util;
...
function handleIfStatementComments(text, precedingNode, enclosingNode, followingNode, comment, options) {
    ...
    // it is a ).
    const nextCharacter = getNextNonSpaceNonCommentCharacter(text, options.locEnd(comment));
    if (nextCharacter === ")") {
...
function handleMethodNameComments(text, enclosingNode, precedingNode, comment, options) {
    ...
    if (enclosingNode &&
        ...
        getNextNonSpaceNonCommentCharacter(text, options.locEnd(precedingNode)) !== ":") {
        addTrailingComment(precedingNode, comment);
        return true;
    }
...
function handleFunctionNameComments(text, enclosingNode, precedingNode, comment, options) {
    if (getNextNonSpaceNonCommentCharacter(text, options.locEnd(comment)) !== "(") {
        return false;
    }
    if (precedingNode &&
        enclosingNode &&
...
function handleCommentAfterArrowParams(text, enclosingNode, comment, options) {
    ...
    const index = getNextNonSpaceNonCommentCharacterIndex(text, options.locEnd(comment));
...
function handleLastFunctionArgComments(text, precedingNode, enclosingNode, followingNode, comment, options) {
    ...
    if (precedingNode &&
        ...
        (enclosingNode.type === "ArrowFunctionExpression" ||
            ...
            enclosingNode.type === "ObjectMethod" ||
            enclosingNode.type === "ClassMethod") &&
        getNextNonSpaceNonCommentCharacter(text, options.locEnd(comment)) === ")") {
        addTrailingComment(precedingNode, comment);
        return true;
    }
    return false;
