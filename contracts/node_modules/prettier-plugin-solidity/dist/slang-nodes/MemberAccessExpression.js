...
function isEndOfChain(node, path) {
    for (let i = 2, current = node, grandparent = path.getNode(i); isChainableExpression(grandparent); i += 2, current = grandparent, grandparent = path.getNode(i)) {
        switch (grandparent.kind) {
            ...
            case NonterminalKind.IndexAccessExpression:
                ...
                if (current !== grandparent.operand.variant)
                    return true;
                break;
